...
public class PConsumer implements IConsumer<ConsumerRecord<String, ESensorRecord>> {
    ...
    public static void main(String args[]) {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "sensorRecordsRepository");
        ...
        //properties.put(ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, "10");
        
        List<String> topics = Arrays.asList("sensor");
        EConsumer consumer = new EConsumer(properties, topics, 6);
